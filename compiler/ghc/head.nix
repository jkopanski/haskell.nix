...
# build-tools
, bootPkgs
, autoconf, automake, coreutils, fetchgit, fetchpatch, perl, python3, m4, sphinx, numactl
, autoreconfHook
, bash
...
in let configured-src = stdenv.mkDerivation (rec {
  ...
  postPatch = "patchShebangs .";
        ...
        src = fetchgit { inherit (src-spec) url rev sha256; };
        ...
        preConfigure = ''
            ...
            echo ${src-spec.version} > VERSION
            echo ${src-spec.rev} > GIT_COMMIT_ID
            ./boot
